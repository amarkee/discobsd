...
char flagchar[] = { 'x', 'n', 'v', 't', STDFLG, 'i', 'e', 'r', 'k', 'u', 'h',
	'f', 'a', 0 };
...
char *from[];
{
	register struct dolnod *np = (struct dolnod *)alloc(
	    sizeof(char **) * n + 3 * BYTESPERWORD);
